        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="glass-effect fusion-shadow hover:shadow-2xl transition-all duration-300 border-0">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">Edite seus dados e preferências</p>
                <Button
                  className="w-full fusion-gradient text-white shadow-lg hover:shadow-xl transition-all"
                  onClick={() => navigateTo("InstructorProfile")}
                >
                  Editar Perfil
                </Button>
              </CardContent>
            ...
            <Card className="glass-effect fusion-shadow hover:shadow-2xl transition-all duration-300 border-0">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">Veja avisos da administração</p>
                <Button
                  className="w-full fusion-gradient text-white shadow-lg hover:shadow-xl transition-all"
